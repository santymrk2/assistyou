...
const authConfig = defineConfig({
  providers: [
    Google({
      clientId: "1066278539480-a7l6s32ohv49qgo862qa4lmrcn1rrtof.apps.googleusercontent.com",
      clientSecret: "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"
    })
  ]
});
...
function AstroAuth(options = authConfig) {
  const { AUTH_SECRET, AUTH_TRUST_HOST, VERCEL, NODE_ENV } = Object.assign(__vite_import_meta_env__, { AUTH_SECRET: "624fc2b63248d3f0d69d8fcf7e878bf2d61375110aaf6ffbdf04877a50e2b16d", AUTH_TRUST_HOST: "true", _: process.env._, NODE: process.env.NODE, NODE_ENV: process.env.NODE_ENV });
...
async function getSession(req, options = authConfig) {
  options.secret ??= "624fc2b63248d3f0d69d8fcf7e878bf2d61375110aaf6ffbdf04877a50e2b16d";
